...
def main() -> int:
    ...
    # Cat Belly (Gray)
    art.gradient_coordinates(
        [(231, 231, 231), (231, 231, 231)], (18, 3), (19, 3), bg=True
    )
    ...
    # Cat Eyes (Cyan)
    art.gradient_coordinates([(0, 255, 255), (0, 255, 255)], (18, 1), (20, 1))
    ...
    art.gradient_coordinates(tree_colors, *tree_coords, space="hsl")
    ...
    footer = (
        ...
        .gradient([(0, 255, 255), (255, 0, 255)], skip_whitespace=True)
        .center(80)
    )
